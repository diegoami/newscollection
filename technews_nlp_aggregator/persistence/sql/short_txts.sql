...
DECLARE SHORT_ATX_TXT_ID_CURSOR CURSOR FOR SELECT AIN_ID, AIN_TITLE, ATX_TEXT, AIN_URL FROM ARTICLE_INFO, ARTICLE_TEXT WHERE ATX_AIN_ID = AIN_ID AND (LENGTH(ATX_TEXT) < 600 OR LENGTH(AIN_TITLE) < 10);
