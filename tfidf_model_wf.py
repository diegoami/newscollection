...
def create_tfidf_model(config, param_config):
    ...
    tfidfGenerator = TfidfGenerator( model_dir, no_below=int(param_config['tdf_no_below']), no_above=float(param_config['tdf_no_above']) , num_topics=int(param_config['tdf_num_topics']), version = config['version'] )
