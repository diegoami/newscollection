ssh ubuntu@18.194.147.93 'find /media/diego/QData/techarticles/models/doc2vec -mtime +1 -type d | xargs rm -f -r'
ssh ubuntu@18.194.147.93 'find /media/diego/QData/techarticles/models/lsi -mtime +1 -type d | xargs rm -f -r'
