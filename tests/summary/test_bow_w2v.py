...
def bow_w2v(application, n_articles=20 ):
    ...
    for i in range(n_articles):
        ...
        id1 = _.articleLoader.articlesDF[_.articleLoader.articlesDF['article_id'] == art_id1].index[0]
        id2 = _.articleLoader.articlesDF[_.articleLoader.articlesDF['article_id'] == art_id2].index[0]
