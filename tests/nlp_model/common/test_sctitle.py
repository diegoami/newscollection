...
from technews_nlp_aggregator.nlp_model.common import ArticleLoader, Tokenizer,TechArticlesSentenceTokenizer
...
tokenizer = Tokenizer(sentence_tokenizer=TechArticlesSentenceTokenizer())
