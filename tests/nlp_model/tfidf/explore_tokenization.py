...
import yaml
from technews_nlp_aggregator.nlp_model.common import TechArticlesSentenceTokenizer, TechArticlesTokenExcluder, TechArticlesWordTokenizer, DefaultTokenizer
...
tokenizer = DefaultTokenizer(sentence_tokenizer=TechArticlesSentenceTokenizer(), token_excluder=TechArticlesTokenExcluder(), word_tokenizer=TechArticlesWordTokenizer())
